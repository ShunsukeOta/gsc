...
export default function OpportunitiesPage() {
  return (
    <>
      <PageHead eyebrow="Opportunity intelligence / Phase 05-02" title="改善機会" description="選択中の検索タイプで改善候補を抽出し、GSC数値のAI診断から対象ページ本文を使った実リライトまで同じ画面で進めます。" actions={<><AnalysisExportButton dataset="opportunities" label="候補CSV" /><RefreshAnalysisButton label="候補を再分析" icon={<Sparkles />} /></>} />
